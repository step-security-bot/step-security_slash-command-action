...
[![CI](https://github.com/step-security/slash-command-action/workflows/CI/badge.svg?branch=main)](https://github.com/step-security/slash-command-action/actions/workflows/ci.yml)
  ...
  check_comments:
    ...
    steps:
      - name: Check for Command
        id: command
        uses: step-security/slash-command-action@v2
        with:
          command: test
          reaction: "true"
          reaction-type: "eyes"
